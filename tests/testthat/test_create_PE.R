...
test_that("Correct prediction for PE(16:0/18:1(9Z)), [M+H]+, std template", {
  ...
  ## tests
  expect_equal(round(precursorMz(pe_spec), 4), 718.5381)
  expect_equal(unlist(round(mz(pe_spec), 4)), c(239.2369, 265.2526, 313.2737,
...
test_that("Correct prediction for PE(16:0/18:1(9Z)), [M+Na]+", {
  ...
  ## tests
  expect_equal(round(precursorMz(pe_spec), 4), 740.5201)
  expect_equal(unlist(round(mz(pe_spec), 4)), c(164.0083, 415.2220, 441.2376,
...
test_that("Correct prediction for PE(16:0/18:1(9Z)), [M-H]-, std template", {
  ...
  ## tests
  expect_equal(round(precursorMz(pe_spec), 4), 716.5236)
  expect_equal(unlist(round(mz(pe_spec), 4)), c(122.0013, 140.0118, 255.2330,
...
test_that("Correct prediction for PE(16:0/18:1(9Z)), [M-H]-, user-def template", {
  ...
  ## tests
  expect_equal(round(precursorMz(pe_spec), 4), 716.5236)
  expect_equal(unlist(round(mz(pe_spec), 4)), c(716.5236))
  expect_equal(unlist(intensity(pe_spec)), c(999))
  ...
  ## tests
  expect_equal(round(precursorMz(pe_spec), 4), 716.5236)
  expect_equal(unlist(round(mz(pe_spec), 4)), c(452.2783, 478.2939, 716.5236))
  expect_equal(unlist(intensity(pe_spec)), c(100, 100, 999))
  ...
  ## tests
  expect_equal(round(precursorMz(pe_spec), 4), 716.5236)
  expect_equal(unlist(round(mz(pe_spec), 4)), c( 255.2330, 281.2486, 452.2783,
                                                 478.2939, 716.5236))
  expect_equal(unlist(intensity(pe_spec)), c(999, 999, 100, 100, 999))
})